...
namespace LitJson
{
	...
	public class JsonReader
	{
		...
		static readonly char[] decimalChars = new char[] { '.', 'e', 'E' };
		#region Private Methods
		private void ProcessNumber(string number)
		{
			if (number.IndexOfAny(decimalChars) != -1)
			{
				float n_float;
				if (float.TryParse(number, NumberStyles.Float, CultureInfo.InvariantCulture, out n_float))
				{
